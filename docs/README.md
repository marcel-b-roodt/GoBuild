# GoBuild — Documentation

**GoBuild** is a free, open-source ProBuilder-equivalent editor plugin for Godot 4.
...
| File | What it covers |
|---|---|
| [goal.md](goal.md) | Product vision — what GoBuild is and is not |
...
| Resource | Link |
|---|---|
| User guide | [GUIDE.md](../GUIDE.md) at the repo root |
| Changelog | [CHANGELOG.md](../CHANGELOG.md) |
| Contributing | [CONTRIBUTING.md](../CONTRIBUTING.md) *(coming soon)* |
| GitHub repo | https://github.com/marcel-b-roodt/GoBuild |
